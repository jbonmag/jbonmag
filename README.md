...
<p align="center">
  <img src="https://github.com/user-attachments/assets/3b53d199-b598-4002-8982-9b32c0f249f1" alt="Profile banner" width="100%">
</p>

<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&duration=2800&pause=900&color=58A6FF&center=true&vCenter=true&width=900&lines=AI+Engineer;Machine+Learning+Engineer;Data+Scientist;RAG+and+LLM+Systems;Cloud+and+Automation" alt="Typing introduction">
</p>

<h2 title="自己紹介">About me</h2>

I am an AI and Machine Learning engineer focused on production-ready LLM systems, RAG architectures, data pipelines, cloud automation and practical software delivery. I like building projects that combine clean code, reproducible workflows and clear documentation.
...
$ focus
LLM systems · RAG · MLOps · FastAPI services · Cloud automation

$ current_stack
Python · PySpark · SQL · XGBoost · FastAPI · Qdrant · n8n · Docker · AWS · GCP
```

<details>
<summary>Japanese profile</summary>

AI / ML エンジニアとして、LLM システム、RAG アーキテクチャ、データパイプライン、クラウド自動化、実運用を意識したソフトウェア開発に取り組んでいます。再現性のあるワークフロー、読みやすいコード、明確なドキュメントを重視しています。

</details>

## Currently building

- Production-oriented AI automation systems with LLM, RAG and workflow orchestration.
- Predictive ML services exposed through FastAPI and containerized delivery.
- Local-first data and retrieval stacks with PostgreSQL, pgvector and Qdrant.
...
### Languages, databases and creative tools
...
<p align="center">
  <a href="https://github.com/jbonmag/local-rag-pgvector">
    <img src="https://github-readme-stats.vercel.app/api/pin/?username=jbonmag&repo=local-rag-pgvector&theme=github_dark&hide_border=true" alt="local-rag-pgvector">
  </a>
  <a href="https://github.com/jbonmag/LM_Conversacional_Basico">
    <img src="https://github-readme-stats.vercel.app/api/pin/?username=jbonmag&repo=LM_Conversacional_Basico&theme=github_dark&hide_border=true" alt="LM Conversacional Basico">
  </a>
  <a href="https://github.com/jbonmag/Housing-ML">
    <img src="https://github-readme-stats.vercel.app/api/pin/?username=jbonmag&repo=Housing-ML&theme=github_dark&hide_border=true" alt="Housing ML">
  </a>
  <a href="https://github.com/jbonmag/Amazon-Product-Reviews-Classifier-with-PySpark">
    <img src="https://github-readme-stats.vercel.app/api/pin/?username=jbonmag&repo=Amazon-Product-Reviews-Classifier-with-PySpark&theme=github_dark&hide_border=true" alt="Amazon Product Reviews Classifier with PySpark">
  </a>
</p>

## 42Barcelona

- [42 repository](https://github.com/jbonmag/42)
- [Piscine 42](https://github.com/jbonmag/42/tree/main/Piscine%2042)
...
- Python with Databases, University of Michigan.
- Hacking and Cybersecurity.
- AWS Machine Learning Associate, in progress.

## Public repositories

This section is updated automatically from my public GitHub repositories.
...
| [kaggle-courses](https://github.com/jbonmag/kaggle-courses) | Kaggle courses and tutorials to get you started in the Data Science world. | Not specified |
...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/jbonmag/jbonmag/output/github-contribution-grid-snake-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/jbonmag/jbonmag/output/github-contribution-grid-snake.svg">
    <img alt="Contribution snake animation" src="https://raw.githubusercontent.com/jbonmag/jbonmag/output/github-contribution-grid-snake.svg">
  </picture>
</p>

<p align="center">
  <img src="https://hits.sh/github.com/jbonmag.svg?style=flat-square&label=Profile%20views&color=2f81f7" alt="Profile views">
</p>
